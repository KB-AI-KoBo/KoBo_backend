...
//    }
    ...
    public boolean isAccountNonExpired() {
        // 계정 만료 여부를 판단하는 로직을 추가합니다.
        return true; // 기본적으로 계정이 만료되지 않았다고 가정
    }

    @Override
    public boolean isAccountNonLocked() {
        // 계정 잠금 여부를 판단하는 로직을 추가합니다.
        return true; // 기본적으로 계정이 잠겨 있지 않다고 가정
    }

    @Override
    public boolean isCredentialsNonExpired() {
        // 자격 증명 만료 여부를 판단하는 로직을 추가합니다.
        return true; // 기본적으로 자격 증명이 만료되지 않았다고 가정
    }

    @Override
    public boolean isEnabled() {
        // 계정 활성화 여부를 판단하는 로직을 추가합니다.
        return true; // 기본적으로 계정이 활성화되었다고 가정
    }
}
